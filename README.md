...
A lightweight 2D action arena game inspired by Alan Becker's *Animator vs. Animation* and *Animation vs. Minecraft*. Play as **The Second Coming** (the orange stick figure), chaining martial arts, pencil attacks, sketch tools, and ally assists across eighteen desktop-themed stages.
...
Eighteen computer-desktop stages with obstacles, platforms, a clear **Start Door**, and an **Exit Door** guide:
...
- **Stage 15: Creeper Clan Replay**: Face **CREEPER LORD // REPLAY**, H4C3R's corrupted copy of the towering, crowned clan leader. Dodge its warned leaps and expanding staff blasts to break the replay shell.
- **Stage 16: Giant Cat Replay**: Outsmart **GIANT CAT // REPLAY**, a huge orange tabby playback with green eyes, broad paw sweeps, and a telegraphed pounce. It is a hacked recording of the normally friendly cat, not the real cat.
- **Stage 17: Lucky Dimension Cache**: Outplay **The Lucky Orb**, a white-hot chance engine controlling a broken Lucky Block cage and golden staff echoes. Its signature move is a three-hop **Lucky Bounce** — stand in a hop gap or jump a landing beat — plus three telegraphed prize-drop silhouettes.
- **Stage 18: Zero-Day Mainframe**: The original zero-day editor **H4C3R** attacks with packet dashes, bracket walls, decoys, and a telegraphed terminal beam.
...
- **Boss Finish Bursts**: Every boss ends in a capped procedural explosion of colored character shards, rings, speedlines, and a comic `KABOOM!`.
