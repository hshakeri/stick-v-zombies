  ...
  constructor() {
    this.upgrades = [
      ...
      },
      {
        ...
        name: 'Agility & Speed',
        icon: '👟',
        desc: 'Increases sprint speed by +12% and jump height.',
        level: 0,
        maxLevel: 4,
        baseCost: 20,
        costMultiplier: 1.5,
      ...
      },
      {
        ...
        icon: '👥',
        desc: 'Reduces all Stick Allies (Red, Blue, Yellow, Green) cooldowns by 25%.',
        level: 0,
        maxLevel: 3,
        baseCost: 50,
        costMultiplier: 1.8,
