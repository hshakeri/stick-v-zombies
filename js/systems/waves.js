import { Zombie } from '../entities/zombies.js?v=9.8';
import { DarkLord } from '../entities/dark_lord.js?v=9.8';
import { KingOrange } from '../entities/king_orange.js?v=9.8';
import { H4C3R } from '../entities/h4c3r.js?v=9.8';
import { LuckyOrb } from '../entities/lucky_orb.js?v=9.8';
...
this.spawnTimer=this.spawnSerial=0;this.usesAuthoredRecipe=false;
this.spawnSerial = 0;
